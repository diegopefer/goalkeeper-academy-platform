<?php $this->assign('title', 'Editar vídeo | Administración EDPAP'); ?>
		...
		<div class="col-12 col-md-6">
			<div class="card border-0 shadow">
				<div class="card-header bg-dark">
					<h5 class="mb-0 text-light font-weight-bold">EDITAR VÍDEO</h5>
				</div>
					<div class="card-body">
						...
						<fieldset>
							<div class="row">
									...
									<div class=" col-8 form-group">
										...
										<label class="font-weight-bold">Fecha <small class="form-text text-muted d-inline"> (actualmente en la base de datos: <b><?= $video->fechaV; ?></b>)</small></label>
								...
								<div class="col-12 d-flex justify-content-end">
									...
									<?= $this->Form->button(__('Actualizar video'),['class' => 'btn btn-success ml-2'])?>
